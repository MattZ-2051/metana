...
contract MyToken is ERC1155URIStorage {
    ...
    constructor(
        ...
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/QmRf8tKk2os6XVdXK4urrRc3zfBNMEQwPPMx3FoKr6AZDQ/{id}"
        )
    {
        owner = _owner;
    }
...
contract Forge is ReentrancyGuard {
    ...
    function trade(uint256 _tokenToTrade, uint256 _tokenToReceive) external {
        ...
        require(_tokenToTrade <= 6, "token id not in collection");
        require(
            _tokenToTrade != _tokenToReceive,
